...
def test_reviewer_logic_routing():
    ...
    # An error under the retry cap goes back to the editor...
    assert reviewer_logic({**base, "editor_error": "boom"}) == "async_editor_node"

    # ...and at the cap it escalates instead of looping forever.
    at_cap = {**base, "editor_error": "boom", "editor_retries": 3}
